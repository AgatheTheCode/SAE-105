...
$qia = [
  ...
  'altflag' => 'drapeau de la pride original',
  'title' => 'QIA+',
  ...
  'capt' => 'Photo de Hanne Gaby Odiele, mannequin belge intersexe.',
...
'corps' => 'Homosexuality isn\'t classified as a disease since 17thmay 1990 ',

'aside' => ' 90% of LGBT youth feel safer nowadays',

'titre' => 'G as Gay',

'figure' =>'',
   
'capt' => 'Picture of Alan Turing, gay mathematician.',
];
...
'corps' => 'Bisexuality is defined by an atraction romantic or sexual toward both gender',

'aside' => '80% of the population have bisexual tendancies' ,
...
'capt' => 'Picture of Freddi Mercury',
];
...
'corps' => 'In some ancients civilisation transgender where seen as intermediates between gods and human, and were considered priestess (Instead of making your Strabuks order...)',

'aside' => 'Stonewall riot where strated by a transgender woman. This riot then became the Pride',

'titre' => 'T as Transgenre',


'figure' =>'',
   
'capt' => 'Picture de Marsha P.Johnson, transgender woman',
];

$qia_en = [

'altflag' => 'Orginal pride flag',
'title' => 'QIA+',
...
'corps' => 'Q I an A stand for "Queer", "Intersex" and "Asexual".',

'aside' => 'France is condamned every year to pay fines by the European Union because of operation on intersex babies',
...
'capt' => 'Picture of Hanne Gaby Odiele intersexe model.',
